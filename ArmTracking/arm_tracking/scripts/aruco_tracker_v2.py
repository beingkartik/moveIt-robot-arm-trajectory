...
# -*- coding: utf-8 -*-
"""
Created on Thu May 14 13:44:03 2020
...
def estimatePose(frame, marker_side, camera_instrinsic,dist):
...
#camera_instrinsic = camera intrinsic matrix , dist =  distortion coefficients (k_1, k_2, p_1, p_2[, k_3[, k_4, k_5, k_6]]) 

if __name__ == "__main__":
    
    camera_instrinsic = np.array(((617.0026849655,-0.153855356,315.5900337131),#fx, s,cx
    ...
    path = '/home/kartik/catkin_ws/src/kinova-ros/ArmTracking/arm_tracking/scripts'
    image_folder = 'stitched_image'
...
#                    os.remove(os.path.join(path,image_folder,image_))
            ...
            try:
                ...
                output = estimatePose(frame,marker_side, camera_instrinsic, dist)
                for tracker in output:
...
#                    point_.append(str(i))
            ...
            with open(os.path.join(path,'document.csv'),'a') as fd:
